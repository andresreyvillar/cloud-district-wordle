...
CIERRE: dict[str, tuple[str, ...]] = {
    INCREDULIDAD: (
        ...
        "El rosco se ha caído a la primera vuelta y {jugador} ya estaba en la puerta.",
        "Hay dos pastillas y {jugador} se ha tomado las dos.",
        "Nadie sale del laberinto en {dato:.0f} sin llevar el plano encima.",
        "Alguien ha visto el diccionario antes de entrar, y no diré nombres.",
        "Un {dato:.0f} así no se acierta: se filtra.",
        "Esto huele a tomate y a tertulia de tarde.",
        "Exclusiva: {jugador} y el misterio de los {dato:.0f} intentos.",
        "Aquí hay impostor y no lleva la cuadrícula puesta.",
        "Se abre expediente, con linterna y voz grave.",
        "Que alguien revise las cámaras del pasillo.",
        "{jugador} lo llevaba escrito en la mano, como en los exámenes.",
        "Modo dios, y sin que nadie haya escrito el código.",
        "Esto no lo explica ni un documental de tres capítulos.",
        "Hasta aquí puedo leer, y lo que leo no me cuadra.",
        "Un {dato:.0f} limpio. Demasiado limpio, señoría.",
        "{jugador} llegó, vio y venció. Sospechosamente rápido.",
        "Portada, foto pequeña y muchas preguntas sin responder.",
    ...
    EPICA: (
        ...
        "Remontada de las que se cuentan en el bar veinte años.",
        "No pasarás, dijo la palabra. Y {jugador} pasó.",
        "Nivel imposible, pasado a pelo y sin guardar.",
        "Épica de última jornada, con el estadio en pie.",
        "{jugador} vino, vio y venció.",
        "Hoy alguien ha hecho la jugada del año.",
        "Esto va directo al vídeo de mejores momentos.",
        "Un intento menos y era leyenda. Por poco.",
        "Que la fuerza le acompañe, que hoy desde luego lo ha hecho.",
        "De estas jornadas se sale con galones y una cicatriz.",
        "El rosco completo, y con tiempo de sobra.",
        "{jugador} ha vuelto del futuro con la respuesta puesta.",
        "Hoy el diccionario ha encontrado la horma de su zapato.",
        "Jefe derrotado, y sin gastar pociones.",
        "Partida para el capítulo final de temporada.",
        "Palabra dura, {dato:.0f} intentos, cero excusas.",
        "Esto es de las que se cuentan a los nietos.",
        "Hoy hemos visto historia, y en cinco letras.",
        "Se acabó la resistencia: {jugador} ha cerrado la jornada.",
    ),
    DERROTA: (
        ...
        "Hoy la palabra jugaba en casa y con el árbitro de su parte.",
        "Eliminados en la primera prueba, sin discusión.",
        "Spain, zero points.",
        "You died. Y otra vez. Y otra.",
        "Nos ha pasado por encima como un final de temporada mal escrito.",
        "Hoy no había nivel fácil disponible.",
        "La vaquilla nos ha ganado por goleada.",
        "Aquí hemos venido a sufrir, y objetivo cumplido.",
        "Capítulo de los que se ven entre los dedos.",
        "Derrota gorda, de las que no se comentan en la oficina.",
        "El rosco entero en blanco.",
        "Volveremos. Mañana. Con más intentos.",
        "Hoy la palabra nos ha hecho el pasillo, pero de salida.",
        "Ni dando cera ni puliendo cera.",
        "Se cierra el acta y no la firma nadie.",
        "Hoy hasta el tutorial nos habría eliminado.",
    ),
    RUTINA: (
        ...
        "Capítulo de los que se ven en diagonal.",
        "El diccionario ha cumplido el expediente.",
        "Hoy sin tomate: todos correctos y aburridos.",
        "Jornada de las que se olvidan antes de cenar.",
        "Ni para lo mejor ni para lo peor del día.",
        "Hoy la palabra ha venido a fichar.",
        "Trámite. Siguiente.",
        "Hoy el guion no ha querido arriesgar.",
